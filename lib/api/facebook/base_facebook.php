 ...
 */
class SAIOB_FacebookApiException extends Exception
{
  /**
 ...
 * @author Naitik Shah <naitik@facebook.com>
 */
abstract class SAIOB_BaseFacebook
{
  /**
   * Version.
   */
  ...
  public function makeRequest($url, $params, $ch=null) {
    ...
    if ($result === false) {
      $e = new SAIOB_FacebookApiException(array(
  ...
  protected function throwAPIException($result) {
    $e = new SAIOB_FacebookApiException($result);
    switch ($e->getType()) {
      // OAuth 2.0 Draft 00 style
      case 'OAuthException':
        // OAuth 2.0 Draft 10 style
