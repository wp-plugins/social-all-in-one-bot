...
class SkinnyUser {
   ...
   */
   public static function getUser() {
      ...
      if (file_exists(WP_SOCIAL_ALL_IN_ONE_BOT_DIRECTORY."tmp/".session_id().".session")) {
         $sess = unserialize(@file_get_contents(WP_SOCIAL_ALL_IN_ONE_BOT_DIRECTORY."tmp/".session_id().".session"));
   ...
   */
   public function save() {
      $data = serialize($this);
      return file_put_contents(WP_SOCIAL_ALL_IN_ONE_BOT_DIRECTORY."tmp/".session_id().".session", $data);
   }
   ...
   */
   public function destroy() {
      return @unlink(WP_SOCIAL_ALL_IN_ONE_BOT_DIRECTORY."tmp/".session_id().".session");
   }
